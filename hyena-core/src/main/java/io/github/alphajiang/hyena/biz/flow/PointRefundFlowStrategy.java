...
@Slf4j
@Service
public class PointRefundFlowStrategy extends AbstractPointFlowStrategy {
    ...
    public void addFlow(PointUsage usage, PointPo point) {
        PointLogPo pointLog = this.pointLogDs.addPointLog(usage.getType(), PointStatus.REFUND, usage, point);
